...
export default function Home() {
  ...
  const jsonLd = {
    ...
    description: 'Виробництво та продаж шамотних плит для каміну, вогнетривких плит для печей та барбекю.',
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'UA',
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        <Head>
          <title>Термокераміка | Шамотні плити та вогнетривкі матеріали</title>
          <meta
            name="description"
            content="Термокераміка – провідний виробник шамотних плит та вогнетривких матеріалів в Україні. Надійні рішення для печей, камінів та промислових установок."
          />
          <meta
            name="keywords"
