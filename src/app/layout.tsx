...
export const metadata: Metadata = {
  title: 'Шамотна плита купити | Вогнетривка плита для каміну | Термокераміка',
  description: 'Виробництво та продаж шамотних плит для каміну, вогнетривких плит для печей та барбекю. Шамотна плита для каміну, вогнетривка плита для печей. Висока якість, доступні ціни, швидка доставка по всій Україні. Termokeramika - надійний виробник вогнетривких матеріалів.',
  keywords: 'шамотна плита, вогнетривка плита, плити для каміну, шамотні плити для печей, вогнетривкі плити для барбекю, термокераміка, шамотна цегла, промислові печі, футерування, вогнетривкі матеріали, шамотні плити купити, вогнетривка плита купити, плити для каміну купити, шамотна плита для каміну, вогнетривка плита для печей, шамотні плити для барбекю',
  openGraph: {
